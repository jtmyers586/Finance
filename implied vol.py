    ...
    while 1:
        ...
        if option_type == 'c':
            ...
            if (lower_price - option_price) * (price - option_price) > 0:
                ...
                upper_vol = mid_vol
            else abs(price - option_price) < precision: break if mid_vol > max_vol - 5 :
                mid_vol = 0.000001
                break
            ...
            if (upper_price - option_price) * (price - option_price) > 0:
                ...
                lower_vol = mid_vol
            else abs(price - option_price) < precision: break if iteration > 50: 
              break
